...
def gen_run_folder(path_model_id=''):
    ...
    if not os.path.isdir(path_model_id):
        path_model_root = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, '/home/RUS_CIP/st176497/dl-lab-22w-team04/Human_Activity_Recognition/experiments'))
